...
; typeface font:
	...
	ctxtmap "Ö",        $c7, 10111011010

	ctxtmap "é",        $c8, 001101000110110
	ctxtmap "ä",        $c9, 1000011101101000000
	ctxtmap "ö",        $ca, 00110100001101101
	ctxtmap "<BOLDH>",  $cb, 0011010001101010111
	ctxtmap "ü",        $cc, 100001110110100010
	ctxtmap "ß",        $cd, 110101111100111000

	ctxtmap "Ä",        $ce, 100001110110100011
	ctxtmap "Ü",        $cf, 0011010001101010110
