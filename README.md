...
- **DragonShrine Q5:** `menu_coords` 11→**10** damit **Schwach** (7) mit Cursor passt
- Full-Audit `tools/audit_menu_box_widths.py` über maps/engine/data/home: 7 Treffer gefixt (Battle Tower Eintreten/Ja-Nein, Hyper-Test PROF. WESTWOOD, Spielhalle-Preise, Milch-Menü)
- Audit-Report: 0 Overflows; Workflow-Regel W7 ergänzt
