...
.BeatenText:
	text "Schwimm schwimm"
	line "hungrig, schwimm"
	cont "schwimm hungrig!"
	done
...
.SeenText:
	text "Wenn ein Ei den"
	line "Berg hinabrollt,"

	para "ist es dann ein"
	line "Eiroll?"
	done
...
GenericTrainerBakerOlga:
	...
	line "zu einem gesunden"

	para "Leben ist ein"
	line "gutes Frühstück."
	done
