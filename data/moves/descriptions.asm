...
DrainPunchDescription:
	text "Stiehlt die Hälfte"
	next "des Schadens."
	done

DrainKissDescription:
	text "Stiehlt 3/4 des"
	next "Schadens."
	done
...
OutrageDescription:
	text "Wirkt 2-3 Runden"
	next "und verwirrt dann."
	done
...
HexDescription:
	text "Doppelter Schaden"
	next "bei Status-Gegner."
	done

AvalancheDescription:
	text "Doppelter Schaden,"
	next "bei zuvor getroff."
	done
...
DragonClawDescription:
	text "Schlitzt Gegner"
	next "mit Krallenhieb."
	done
...
DragonPulseDescription:
	text "Greift mit einer"
	next "Schockwelle an."
	done

AquaTailDescription:
	text "Schwingt den"
	next "Schweif in Wellen."
	done
...
HyperVoiceDescription:
	text "Greift den Gegner"
	next "mit Schallwellen."
	done
...
PowerGemDescription:
	text "Angriff mit Licht"
	next "aus Edelsteinen."
	done
...
BugBiteDescription:
	text "Beißt den Gegner,"
	next "isst dessen Beere."
	done
...
HealingLightDescription:
	text "Heilt KP je nach"
	next "Wetter."
	done

KnockOffDescription:
	text "Schlägt das Item"
	next "des Gegners weg."
	done
...
GyroBallDescription:
	...
	next "niedrigerem Tempo."
	done

TrickDescription:
	text "Vertauscht Items"
	next "mit dem Gegner."
	done
