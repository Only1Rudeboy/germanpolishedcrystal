...
PewterCityName:        rawchar "Mamoria¯City@"
...
PokemonLeagueName:     rawchar "#mon Liga-¯Tor@"
...
PokemonMansionName:    rawchar "#mon¯Villa@"
...
DarkCaveName:          rawchar "Finsterhöhle@"
IlexForestName:        rawchar "Steineichen-¯wald@"
BurnedTowerName:       rawchar "Brannturm@"
...
BattleTowerName:       rawchar "Kampfturnier@"
...
DimCaveName:           rawchar "Dunkle¯Höhle@"
...
CinnabarLabName:       rawchar "#mon¯Labor@"
