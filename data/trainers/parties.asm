...
YoungsterGroup:
	...
	def_trainer MIKEY, "BURKARD"
	tr_mon 2, RATTATA
	tr_mon 4, PIDGEY
	end_trainer

	def_trainer ALBERT, "NIELS"
	tr_mon 8, RATTATA
	tr_mon 10, ZUBAT
	end_trainer

	def_trainer GORDON, "EINAR"
	tr_mon 11, WOOPER
	end_trainer

	def_trainer WARREN, "JOHANNES"
	tr_mon 56, FEAROW
	tr_mon 60, RATICATE
	end_trainer

	def_trainer JIMMY, "EDMUND"
	tr_mon 60, RATICATE
	tr_mon 60, ARBOK
	tr_mon 60, PARASECT
	end_trainer

	def_trainer OWEN, "FRIEDER"
	tr_mon 53, GROWLITHE
	tr_mon 54, GROWLITHE
	end_trainer

	def_trainer JASON, "WERNER"
	tr_mon 55, SANDSLASH
	tr_mon 55, CROBAT
	end_trainer

	def_trainer YOUNGSTER_JOSH, "ENNO"
	tr_mon 60, RATICATE
	tr_mon 62, GOLBAT
	tr_mon 60, RATICATE
	end_trainer
...
BugCatcherGroup:
	...
	def_trainer ARNIE1, "UDO"
	tr_mon 16, VENONAT
	end_trainer

	def_trainer ARNIE2, "UDO"
	tr_mon 20, VENONAT
	end_trainer

	def_trainer ARNIE3, "UDO"
	tr_mon 28, VENOMOTH
		tr_moves DISABLE, SUPERSONIC, CONFUSION, LEECH_LIFE
	end_trainer

	def_trainer ARNIE4, "UDO"
	tr_mon 36, VENOMOTH
		tr_moves GUST, SUPERSONIC, PSYBEAM, LEECH_LIFE
	end_trainer

	def_trainer ARNIE5, "UDO"
	tr_mon 40, VENOMOTH
	...
	def_trainer JOSH, "ENNO"
	tr_mon 12, PARAS
	tr_mon 12, VENONAT
	end_trainer

	def_trainer KEN, "RUDI"
	tr_mon 46, ARIADOS
	tr_mon 47, PINSIR
	end_trainer

	def_trainer WAYNE, "THIS"
	tr_mon 9, PARAS
	tr_mon 10, PINECO
	end_trainer
...
CamperGroup:
	...
	def_trainer TODD1, "BODO"
	tr_mon 14, PSYDUCK
	end_trainer

	def_trainer TODD2, "BODO"
	tr_mon 17, GEODUDE
	tr_mon 17, GEODUDE
	tr_mon 23, PSYDUCK
	end_trainer

	def_trainer TODD3, "BODO"
	tr_mon 23, GEODUDE
	tr_mon 23, GEODUDE
	tr_mon 26, PSYDUCK
	end_trainer

	def_trainer TODD4, "BODO"
	tr_mon 30, GRAVELER
	tr_mon 30, GRAVELER
	tr_mon 30, SLUGMA
	tr_mon 32, PSYDUCK
	...
	def_trainer ROLAND, "ERWIN"
	tr_mon 10, NIDORAN_M
	end_trainer

	def_trainer IVAN, "EWALD"
	tr_mon 11, DIGLETT
	tr_mon 11, ZUBAT
	tr_mon 15, DIGLETT
	end_trainer

	def_trainer BARRY, "TILL"
	tr_mon 60, NIDOKING
	end_trainer

	def_trainer LLOYD, "ANSGAR"
	tr_mon 56, NIDOKING
	end_trainer

	def_trainer DEAN, "STEFFAN"
	tr_mon 54, GOLDUCK
	tr_mon 52, SANDSLASH
	end_trainer

	def_trainer SID, "KARL"
	tr_mon 53, DUGTRIO
	tr_mon 51, PRIMEAPE
	tr_mon 51, POLIWRATH
	end_trainer

	def_trainer TED, "PATRICK"
	tr_mon 18, MANKEY
	end_trainer

	def_trainer JOHN, "ROBERT"
	tr_mon 33, GRAVELER
	tr_mon 36, GRAVELER
	tr_mon 40, GOLBAT
	tr_mon 42, GOLDUCK
	...
	def_trainer JERRY, "WALTER"
	tr_mon 62, RHYDON
	end_trainer

	def_trainer SPENCER, "MORITZ"
	tr_mon 28, SANDSHREW
	tr_mon 29, SANDSLASH
	tr_mon 30, GOLBAT
	end_trainer
...
endc
	...
	def_trainer HOPE, "EVELYN"
	tr_mon 62, FLAAFFY
	end_trainer

	def_trainer SHARON, "ASTRID"
	tr_mon 50, FURRET
	tr_mon 52, RAPIDASH
	end_trainer

	def_trainer DEBRA, "HEDWIG"
	tr_mon 50, SEAKING
	end_trainer

	def_trainer HEIDI, "MARIKA"
	tr_mon 53, JUMPLUFF
	tr_mon 53, JUMPLUFF
	end_trainer

	def_trainer EDNA, "KERSTIN"
	tr_mon 51, NIDORINA
	tr_mon 55, RAICHU
	end_trainer

	def_trainer TANYA, "NICOLE"
	tr_mon 61, EXEGGUTOR
	end_trainer
...
TwinsGroup:
	...
	def_trainer MEGANDPEG1, "ZOE & PIA"
	tr_mon 45, TEDDIURSA
	tr_mon 45, PHANPY
	end_trainer

	def_trainer MEGANDPEG2, "ZOE & PIA"
	tr_mon 45, PHANPY
	tr_mon 45, TEDDIURSA
	end_trainer

	def_trainer LEAANDPIA1, "JANA&NANA"
	tr_mon 38, DRATINI
	...
	def_trainer LEAANDPIA2, "JANA&NANA"
	tr_mon 38, DRATINI
		tr_moves THUNDER_WAVE, DRAGON_PULSE, ICE_BEAM, HEADBUTT
	tr_mon 38, DRATINI
		tr_moves THUNDER_WAVE, DRAGON_PULSE, FLAMETHROWER, HEADBUTT
...
FisherGroup:
	...
	def_trainer RALPH1, "ANGELO"
	tr_mon 11, GOLDEEN
	end_trainer

	def_trainer RALPH2, "ANGELO"
	tr_mon 17, GOLDEEN
	end_trainer

	def_trainer RALPH3, "ANGELO"
	tr_mon 17, QWILFISH
	tr_mon 19, GOLDEEN
	end_trainer

	def_trainer RALPH4, "ANGELO"
	tr_mon 30, QWILFISH
	tr_mon 32, SEAKING
	end_trainer

	def_trainer RALPH5, "ANGELO"
	tr_mon 36, QWILFISH
	...
	def_trainer TULLY1, "AMADEUS"
	tr_mon 30, QWILFISH
	end_trainer

	def_trainer TULLY2, "AMADEUS"
	tr_mon 35, GOLDEEN
	tr_mon 35, QWILFISH
	end_trainer

	def_trainer TULLY3, "AMADEUS"
	tr_mon 40, POLIWHIRL
	tr_mon 40, SEAKING
	tr_mon 40, QWILFISH
	end_trainer

	def_trainer TULLY4, "AMADEUS"
	tr_mon 43, POLIWRATH
	...
	def_trainer WILTON1, "ALFRIED"
	tr_mon 34, GOLDEEN
	tr_mon 36, REMORAID
	tr_mon 36, SEAKING
	end_trainer

	def_trainer WILTON2, "ALFRIED"
	tr_mon 36, GOLDEEN
	tr_mon 38, REMORAID
	tr_mon 38, SEAKING
	end_trainer

	def_trainer WILTON3, "ALFRIED"
	tr_mon 38, GOLDEEN
	...
	def_trainer ARNOLD, "ADAM"
	tr_mon 62, CLOYSTER
	end_trainer

	def_trainer KYLE, "ALAIN"
	tr_mon 57, SEAKING
	tr_mon 54, QWILFISH
	tr_mon 57, SEAKING
	end_trainer

	def_trainer HENRY, "ACHMED"
	tr_mon 9, POLIWAG
	tr_mon 9, POLIWAG
	end_trainer


	def_trainer MARVIN, "ANSELM"
	tr_mon 20, MAGIKARP, MALE | MAGIKARP_CALICO1_FORM
	tr_mon 25, MAGIKARP, MALE | MAGIKARP_CALICO2_FORM
	tr_mon 30, GYARADOS, MALE
	end_trainer

	def_trainer ANDRE, "ALOIS"
	tr_mon 32, GYARADOS
	end_trainer


	def_trainer RAYMOND, "ALBERT"
	...
	def_trainer MARTIN, "ANTON"
	tr_mon 56, REMORAID
	tr_mon 58, OCTILLERY
	end_trainer

	def_trainer STEPHEN, "ADRIAN"
	tr_mon 60, MAGIKARP
	tr_mon 58, QUAGSIRE
	tr_mon 55, QWILFISH
	...
	def_trainer BARNEY, "ARMIN"
	tr_mon 57, GYARADOS
	tr_mon 56, GYARADOS
	tr_mon 56, GYARADOS
	end_trainer

	def_trainer SCOTT, "ARTHUR"
	tr_mon 40, QWILFISH
	tr_mon 40, QWILFISH
	tr_mon 42, SEAKING
	end_trainer

	def_trainer PATON, "IVAN"
	...
	def_trainer LEROY, "TASSILO" ; MISMATCH
...
BirdKeeperGroup:
	...
	def_trainer VANCE1, "ARNO"
	tr_mon 36, PIDGEOTTO
	tr_mon 36, PIDGEOTTO
	end_trainer

	def_trainer VANCE2, "ARNO"
	tr_mon 40, PIDGEOTTO
	tr_mon 40, PIDGEOTTO
	end_trainer

	def_trainer VANCE3, "ARNO"
	tr_mon 45, PIDGEOT
	...
	def_trainer TOBY, "TIMO"
	tr_mon 16, DODUO
	tr_mon 17, DODUO
	tr_mon 18, DODUO
	end_trainer

	def_trainer DENIS, "BENNO"
	tr_mon 18, SPEAROW
	tr_mon 20, FEAROW
	tr_mon 18, SPEAROW
	end_trainer

	def_trainer HANK, "JIM"
	tr_mon 13, PIDGEY
	tr_mon 56, PIDGEOT
	end_trainer

	def_trainer ROY, "CHRIS"
	tr_mon 55, FEAROW
	tr_mon 59, PIDGEOT
	end_trainer

	def_trainer BORIS, "FRANK"
	tr_mon 56, DODUO
	tr_mon 55, DODUO
	tr_mon 58, DODRIO
	end_trainer

	def_trainer BOB, "EGON"
	tr_mon 59, NOCTOWL
	end_trainer

	def_trainer PETER, "RICO"
	tr_mon 7, PIDGEY
	tr_mon 8, PIDGEY
	tr_mon 10, SPEAROW
	end_trainer

	def_trainer PERRY, "MARKO"
	tr_mon 59, FARFETCH_D
	end_trainer

	def_trainer BRET, "WOLF"
	tr_mon 57, PIDGEOT
	tr_mon 57, FEAROW
	end_trainer
	...
	def_trainer BIRD_KEEPER_TONY, "VITALI"
	...
	def_trainer BIRD_KEEPER_JUSTIN, "ALBRECHT"
	tr_mon 57, XATU
	tr_mon 50, NOCTOWL
	end_trainer
	...
	def_trainer BIRD_KEEPER_JOSH, "ENNO"
	tr_mon 55, DODRIO
	end_trainer
...
HikerGroup:
	...
	def_trainer ANTHONY1, "TOM"
	tr_mon 12, GEODUDE
	tr_mon 12, MACHOP
	end_trainer

	def_trainer ANTHONY2, "TOM"
	tr_mon 16, GEODUDE
	tr_mon 18, MACHOKE
	end_trainer

	def_trainer ANTHONY3, "TOM"
	tr_mon 25, GRAVELER
	tr_mon 27, GRAVELER
	tr_mon 29, MACHOKE
	end_trainer

	def_trainer ANTHONY4, "TOM"
	tr_mon 30, GRAVELER
	tr_mon 30, GRAVELER
	tr_mon 32, MACHOKE
	end_trainer

	def_trainer ANTHONY5, "TOM"
	tr_mon 34, GRAVELER
	...
	def_trainer PARRY1, "GÜNTER"
	tr_mon 30, ONIX
	end_trainer

	def_trainer PARRY2, "GÜNTER"
	tr_mon 36, ONIX
	tr_mon 35, PILOSWINE
	end_trainer

	def_trainer PARRY3, "GÜNTER"
	tr_mon 36, PILOSWINE
	...
	def_trainer RUSSELL, "BURKARD"
	tr_mon 6, GEODUDE
	tr_mon 8, GEODUDE
	tr_mon 10, GEODUDE
	end_trainer

	def_trainer PHILLIP, "DOMINIK"
	tr_mon 23, GEODUDE
	tr_mon 23, GEODUDE
	tr_mon 25, GRAVELER
	end_trainer

	def_trainer LEONARD, "WENDELIN"
	tr_mon 23, GEODUDE
	tr_mon 25, MACHOP
	end_trainer

	def_trainer BENJAMIN, "WOLFGANG"
	tr_mon 24, DIGLETT
	tr_mon 24, DUNSPARCE
	tr_mon 28, GLIGAR
	end_trainer

	def_trainer ERIK, "WIELAND"
	tr_mon 35, GRAVELER
	tr_mon 37, DONPHAN
	tr_mon 37, GLIGAR
	end_trainer

	def_trainer MICHAEL, "PHILLIP"
	tr_mon 35, GEODUDE
	tr_mon 35, GRAVELER
	tr_mon 35, GOLEM
	end_trainer

	def_trainer TIMOTHY, "ROMAN"
	tr_mon 36, SANDSLASH
	tr_mon 37, DUGTRIO
	end_trainer

	def_trainer BAILEY, "LUDWIG"
	tr_mon 15, GEODUDE
	tr_mon 15, GEODUDE
	tr_mon 15, GEODUDE
	tr_mon 17, LARVITAR
	...
	def_trainer TIM, "HARTMUT" ; MISMATCH
	tr_mon 50, DIGLETT
	tr_mon 52, GRAVELER
	tr_mon 54, DUGTRIO
	end_trainer

	def_trainer NOLAND, "THEODOR"
	tr_mon 45, DUGTRIO
	tr_mon 47, GOLEM
	end_trainer

	def_trainer SIDNEY, "BERNWARD" ; MISMATCH
	tr_mon 53, DUGTRIO
	tr_mon 55, ONIX
	end_trainer

	def_trainer KENNY, "HOLGER"
	tr_mon 54, SANDSLASH
	tr_mon 56, GRAVELER
	tr_mon 58, GOLEM
	tr_mon 56, GRAVELER
	...
	def_trainer JIM, "WILHELM"
	tr_mon 57, MACHAMP
	end_trainer

	def_trainer DANIEL, "KAREL"
	tr_mon 12, ONIX
	end_trainer
...
GruntMGroup:
	...
	def_trainer 10, "RÜPEL"
	tr_mon 32, ZUBAT
	tr_mon 35, GOLBAT
	tr_mon 33, MUK
	end_trainer

	def_trainer 11, "RÜPEL"
	tr_mon 34, MUK
	tr_mon 35, HAUNTER
	tr_mon 36, RATICATE
	end_trainer

	def_trainer 12, "RÜPEL"
	tr_mon 23, RATICATE, MALE
	tr_mon 24, PERSIAN, MALE | ALOLAN_FORM
	end_trainer

	def_trainer 13, "RÜPEL"
	tr_mon 37, RATICATE
	end_trainer

	def_trainer 14, "RÜPEL"
	tr_mon 35, RATICATE
	tr_mon 35, GOLBAT
	end_trainer

	def_trainer 15, "RÜPEL"
	tr_mon 35, MUK
	tr_mon 35, WEEZING
	end_trainer

	def_trainer 16, "RÜPEL"
	...
	def_trainer 17, "RÜPEL"
	tr_mon 32, GOLBAT
	end_trainer

	def_trainer 18, "RÜPEL"
	tr_mon 27, HOUNDOUR
	tr_mon 28, GOLBAT
	tr_mon 28, RATICATE
	end_trainer

	def_trainer 19, "RÜPEL"
	tr_mon 28, VENONAT
	tr_mon 28, VENOMOTH
	end_trainer

	def_trainer 20, "RÜPEL"
	tr_mon 26, ZUBAT
	tr_mon 27, GRIMER
	tr_mon 28, MEOWTH
	end_trainer

	def_trainer 21, "RÜPEL"
	tr_mon 26, DROWZEE
	tr_mon 27, ZUBAT
	tr_mon 28, HAUNTER
	end_trainer

	def_trainer 22, "RÜPEL"
	tr_mon 23, GOLBAT
	tr_mon 23, HAUNTER
	tr_mon 23, GOLBAT
	end_trainer

	def_trainer 23, "RÜPEL"
	tr_mon 23, KOFFING
	tr_mon 25, HOUNDOUR
	tr_mon 23, TENTACOOL
	end_trainer

	def_trainer 24, "RÜPEL"
	tr_mon 37, HAUNTER
	tr_mon 36, WEEZING
	end_trainer

	def_trainer 25, "RÜPEL"
	tr_mon 36, TENTACRUEL
	tr_mon 35, MUK
	end_trainer

	def_trainer 26, "RÜPEL"
	tr_mon 23, ZUBAT
	tr_mon 24, RATICATE
	tr_mon 25, MURKROW
	end_trainer
	...
	; unused
	def_trainer 27, "RÜPEL"
	end_trainer

	def_trainer 28, "RÜPEL"
	tr_mon 33, RATICATE
	end_trainer

	def_trainer 29, "RÜPEL"
	tr_mon 10, RATTATA
	tr_mon 10, MEOWTH
	end_trainer

	def_trainer 30, "RÜPEL"
	tr_mon 25, GOLBAT
	tr_mon 25, GOLBAT
	tr_mon 30, ARBOK
	end_trainer

	def_trainer 31, "RÜPEL"
	tr_mon 51, GOLBAT
	tr_mon 52, WEEZING
	tr_mon 51, MUK
	end_trainer
...
PokefanMGroup:
	...
	def_trainer DEREK1, "SÖNCKE"
	tr_mon 18, PIKACHU @ ORAN_BERRY
	end_trainer

	def_trainer DEREK2, "SÖNCKE"
	tr_mon 19, PIKACHU @ ORAN_BERRY
	end_trainer

	def_trainer DEREK3, "SÖNCKE"
	tr_mon 36, PIKACHU @ SITRUS_BERRY
	end_trainer

	def_trainer WILLIAM, "WILHELM"
	tr_mon 16, RAICHU @ ORAN_BERRY
	end_trainer

	def_trainer ROBERT, "WINFRIED"
	tr_mon 56, QUAGSIRE @ SITRUS_BERRY
	end_trainer

	def_trainer JOSHUA, "JÜRGEN"
...
PokemaniacGroup:
	...
	def_trainer BRENT1, "TARO"
	tr_mon 32, LICKITUNG
	end_trainer

	def_trainer BRENT2, "TARO"
	tr_mon 37, KANGASKHAN
	end_trainer

	def_trainer BRENT3, "TARO"
	tr_mon 42, PORYGON
		tr_moves RECOVER, PSYCHIC_M, CONVERSION, TRI_ATTACK
	end_trainer

	def_trainer BRENT4, "TARO"
	tr_mon 47, CHANSEY
		tr_moves ROLLOUT, ATTRACT, RETURN, FRESH_SNACK
	end_trainer

	def_trainer POKEMANIAC_LARRY, "SATORU"
	tr_mon 12, SLOWPOKE
	end_trainer

	def_trainer ANDREW, "KENJI"
	tr_mon 24, MAROWAK
	tr_mon 24, MAROWAK
	end_trainer

	def_trainer CALVIN, "KENGO"
	tr_mon 26, KANGASKHAN
	end_trainer

	def_trainer SHANE, "GORO"
	tr_mon 20, NIDORINA
	tr_mon 20, NIDORINO
	end_trainer

	def_trainer BEN, "KOUJI" ; MISMATCH
	tr_mon 30, SLOWBRO
	end_trainer

	def_trainer RON, "HIRO"
	tr_mon 30, NIDOKING
	end_trainer

	def_trainer ETHAN, "HIDE"
	tr_mon 45, RHYHORN
	tr_mon 46, RHYDON
	end_trainer

	def_trainer ISSAC, "TAKAO"
	tr_mon 15, LICKITUNG
		tr_moves LICK, SUPERSONIC, CUT
	end_trainer

	def_trainer DONALD, "SHOYA"
	tr_mon 13, SLOWPOKE
	tr_mon 13, NIDORAN_M
	end_trainer

	def_trainer ZACH, "AKIRA"
	tr_mon 37, RHYHORN
	end_trainer
...
SuperNerdGroup:
	...
	def_trainer STAN, "GRIMBALD"
	tr_mon 20, GRIMER
	end_trainer

	def_trainer ERIC, "RAMON"
	tr_mon 13, GRIMER
	tr_mon 14, PORYGON
	end_trainer

	def_trainer SAM, "TORSTEN"
	tr_mon 55, GRIMER
	tr_mon 56, MUK
	end_trainer

	def_trainer TOM, "CHRISTIAN" ; MISMATCH
	tr_mon 55, MAGNEMITE
	tr_mon 56, MAGNETON
	tr_mon 55, MAGNEMITE
	end_trainer

	def_trainer PAT, "THILO"
	tr_mon 56, PORYGON2
	end_trainer

	def_trainer SHAWN, "RAIMUND"
	tr_mon 44, MAGNEMITE
	tr_mon 46, MUK
	tr_mon 45, MAGNETON
	end_trainer

	def_trainer TERU, "ROLF"
	tr_mon 9, MAGNEMITE
	tr_mon 13, VOLTORB
	tr_mon 9, MAGNEMITE
	tr_mon 11, MAGNEMITE
...
endc
	...
	def_trainer KRISE, "MONIKA"
	tr_mon 14, ODDISH
	tr_mon 17, CUBONE
	end_trainer

	def_trainer CONNIE, "RAMONA"
	tr_mon 20, AZUMARILL
	tr_mon 21, MAGNETON
	end_trainer

	def_trainer LINDA, "MECHTHILD"
	tr_mon 57, BULBASAUR
	tr_mon 59, IVYSAUR
	tr_mon 61, VENUSAUR
	end_trainer

	def_trainer LAURA, "ADRIANE"
	tr_mon 52, GLOOM @ SITRUS_BERRY
	tr_mon 54, PIDGEOTTO
	tr_mon 54, BELLOSSOM
	end_trainer

	def_trainer SHANNON, "FRANZISKA"
	tr_mon 53, PARAS
	tr_mon 53, PARAS
	tr_mon 55, PARASECT
	end_trainer

	def_trainer MICHELLE, "STEFANIE"
	tr_mon 56, LEAFEON
	tr_mon 57, TANGELA
	tr_mon 58, JUMPLUFF
	end_trainer

	def_trainer ELLEN, "VERENA"
...
BeautyGroup:
	...
	def_trainer VICTORIA, "MARTHA"
	tr_mon 9, SENTRET
	tr_mon 13, SENTRET
	tr_mon 17, SENTRET
	end_trainer

	def_trainer SAMANTHA, "TINA"
	tr_mon 16, MEOWTH
	...
	def_trainer CASSIE, "MIRJAM"
	tr_mon 47, VILEPLUME
	tr_mon 49, BUTTERFREE
	end_trainer

	def_trainer JULIA, "CORINNA"
	tr_mon 56, PARAS
	tr_mon 56, EXEGGCUTE
	tr_mon 59, PARASECT
	end_trainer
	...
	def_trainer BRIDGET, "BETTINA"
	tr_mon 55, CORSOLA
	tr_mon 55, SUNFLORA
	end_trainer

	def_trainer VERONICA, "MARION"
	tr_mon 54, WIGGLYTUFF
	tr_mon 54, MILTANK
	tr_mon 56, CLEFABLE
	end_trainer

	def_trainer BEAUTY_NICOLE, "ELKE"
...
FirebreatherGroup:
	...
	def_trainer OTIS, "BILL"
	tr_mon 59, MAGMAR
	tr_mon 58, WEEZING
	tr_mon 61, MAGMAR
	end_trainer

	def_trainer DICK, "WULF"
	...
	def_trainer BURT, "TONI"
	tr_mon 59, WEEZING
	tr_mon 61, MAGCARGO
	end_trainer

	def_trainer BILL, "VEIT"
	tr_mon 8, KOFFING
	tr_mon 8, KOFFING
	end_trainer

	def_trainer WALT, "WOLF"
	tr_mon 11, MAGMAR
	tr_mon 16, MAGMAR
	end_trainer
	...
	def_trainer LYLE, "WIM"
	tr_mon 44, KOFFING
	tr_mon 46, FLAREON
	tr_mon 45, WEEZING
	end_trainer

	def_trainer JAY, "GEROLD"
	tr_mon 26, MAGMAR
	end_trainer
...
;	end_trainer
	...
	def_trainer FRITZ, "EIKE"
	tr_mon 45, MR__MIME
	tr_mon 45, MAGMAR
	tr_mon 45, MACHOKE
	end_trainer

	def_trainer HORTON, "IGNAZ"
	tr_mon 53, ELECTRODE
	tr_mon 53, ELECTRODE
	tr_mon 53, ELECTRODE
	end_trainer
...
SchoolboyGroup:
	...
	def_trainer JACK1, "JULIUS"
	tr_mon 12, ODDISH
	tr_mon 15, VOLTORB
	end_trainer

	def_trainer JACK2, "JULIUS"
	tr_mon 14, ODDISH
	tr_mon 17, VOLTORB
	end_trainer

	def_trainer JACK3, "JULIUS"
	tr_mon 28, GLOOM
	tr_mon 31, ELECTRODE
	end_trainer

	def_trainer JACK4, "JULIUS"
	tr_mon 30, GLOOM
	tr_mon 33, GROWLITHE
	tr_mon 33, ELECTRODE
	end_trainer

	def_trainer JACK5, "JULIUS"
	tr_mon 35, ELECTRODE
	...
	def_trainer ALAN1, "HOLGER"
	tr_mon 17, TANGELA
	end_trainer

	def_trainer ALAN2, "HOLGER"
	tr_mon 17, TANGELA
	tr_mon 17, YANMA
	end_trainer

	def_trainer ALAN3, "HOLGER"
	tr_mon 20, NATU
	tr_mon 22, TANGELA
	tr_mon 20, QUAGSIRE
	tr_mon 25, YANMA
	...
	def_trainer CHAD1, "LUTZ"
	tr_mon 20, MR__MIME
	end_trainer

	def_trainer CHAD2, "LUTZ"
	tr_mon 20, MR__MIME
	tr_mon 20, MAGNEMITE
	end_trainer

	def_trainer CHAD3, "LUTZ"
	tr_mon 27, MR__MIME
	tr_mon 31, MAGNETON
	end_trainer

	def_trainer CHAD4, "LUTZ"
	tr_mon 30, MR__MIME
	tr_mon 34, MAGNETON
	end_trainer

	def_trainer CHAD5, "LUTZ"
	tr_mon 34, MR__MIME
	...
	def_trainer NATE, "RUDOLF"
	tr_mon 46, LEDIAN
	tr_mon 48, EXEGGUTOR
	end_trainer

	def_trainer RICKY, "ENRICO"
	tr_mon 44, AIPOM
	tr_mon 46, DITTO
	end_trainer
...
PsychicGroup:
	...
	def_trainer NATHAN, "LIONEL"
	tr_mon 26, GIRAFARIG
	end_trainer

	def_trainer FRANKLIN, "FREDERIC"
	tr_mon 53, KADABRA
	tr_mon 56, GIRAFARIG
	end_trainer

	def_trainer HERMAN, "MARCEL"
	tr_mon 53, EXEGGCUTE
	tr_mon 53, EXEGGCUTE
	tr_mon 55, EXEGGUTOR
	end_trainer

	def_trainer FIDEL, "JEAN"
	tr_mon 57, XATU
	end_trainer

	def_trainer GREG, "LAURENT"
	tr_mon 17, DROWZEE
		tr_moves HYPNOSIS, DISABLE, DREAM_EATER
	end_trainer

	def_trainer NORMAN, "ANDRE"
	tr_mon 17, SLOWPOKE
	...
	def_trainer PHIL, "RENE"
	tr_mon 36, KADABRA
	tr_mon 35, XATU
	end_trainer

	def_trainer RICHARD, "CEDRIC" ; MISMATCH
	tr_mon 44, ESPEON
	end_trainer

	def_trainer GILBERT, "CYRILLE"
	tr_mon 38, STARMIE
	tr_mon 36, EXEGGCUTE
	tr_mon 40, GIRAFARIG
	end_trainer

	def_trainer JARED, "RAINIER"
	tr_mon 53, MR__MIME
	tr_mon 55, EXEGGCUTE
	tr_mon 55, EXEGGCUTE
	end_trainer

	def_trainer RODNEY, "HENRY"
	tr_mon 45, DROWZEE
	tr_mon 47, HYPNO
	end_trainer
...
SageGroup:
	...
	def_trainer CHOW, "HELMUT"
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	end_trainer

	def_trainer NICO, "ECKART"
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	tr_mon 3, HOOTHOOT
	end_trainer

	def_trainer JIN, "DETLEV"
	tr_mon 7, BELLSPROUT
	end_trainer

	def_trainer TROY, "INGOLF"
	tr_mon 7, BELLSPROUT
	tr_mon 7, GASTLY
	end_trainer

	def_trainer JEFFREY, "HERIBERT"
	tr_mon 22, HAUNTER
	tr_mon 21, VULPIX
	end_trainer

	def_trainer PING, "MONTY"
	tr_mon 17, GASTLY
	tr_mon 17, HOOTHOOT
	tr_mon 18, GASTLY
	tr_mon 18, NOCTOWL
	...
	def_trainer EDMOND, "LUDGER"
	tr_mon 3, BELLSPROUT
	tr_mon 3, HOOTHOOT
	tr_mon 3, BELLSPROUT
	end_trainer

	def_trainer NEAL, "LUKAS"
	tr_mon 6, BELLSPROUT
	tr_mon 6, HOOTHOOT
	end_trainer
...
MediumGroup:
	...
	def_trainer MARTHA, "ZENOBIA"
	tr_mon 18, GASTLY
	tr_mon 20, HAUNTER
	tr_mon 20, MISDREAVUS
	end_trainer

	def_trainer GRACE, "DOROTHEA"
	tr_mon 20, HAUNTER
	tr_mon 20, MISDREAVUS
	end_trainer

	def_trainer REBECCA, "ANASTASIA"
	tr_mon 54, DROWZEE
	tr_mon 54, HYPNO
	end_trainer

	def_trainer DORIS, "DAPHNE"
	tr_mon 53, SLOWPOKE
	tr_mon 55, SLOWBRO
	end_trainer
...
KimonoGirlGroup:
	...
	def_trainer SAYO, "KEIKO"
	tr_mon 20, ESPEON @ LUM_BERRY
	end_trainer

	def_trainer ZUKI, "LINDA"
	tr_mon 20, UMBREON @ LUM_BERRY
	end_trainer

	def_trainer KUNI, "WILMA"
	tr_mon 20, VAPOREON @ LUM_BERRY
	end_trainer

	def_trainer MIKI, "LORE"
...
ElderGroup:
	...
	def_trainer LI, "MAREK"
	tr_mon 7, HOOTHOOT
	tr_mon 7, GASTLY
	tr_mon 10, BELLSPROUT
	end_trainer

	def_trainer GAKU, "YORICK"
	tr_mon 37, NOCTOWL
	tr_mon 38, FLAREON
	tr_mon 38, WEEPINBELL
	end_trainer

	def_trainer MASA, "THURE"
	tr_mon 37, NOCTOWL
	tr_mon 38, JOLTEON
	tr_mon 38, WARTORTLE
	end_trainer

	def_trainer KOJI, "ERASMUS"
	tr_mon 37, NOCTOWL
	tr_mon 38, VAPOREON
	tr_mon 38, NINETALES
	end_trainer
...
GentlemanGroup:
	...
	def_trainer PRESTON, "FELIX"
	tr_mon 18, GROWLITHE
	tr_mon 18, SKARMORY
	end_trainer

	def_trainer EDWARD, "CHARLES"
	tr_mon 49, PERSIAN
	end_trainer

	def_trainer GREGORY, "ALFRED"
	tr_mon 56, PIKACHU
	tr_mon 53, FLAAFFY
	tr_mon 53, CHINCHOU
	end_trainer

	def_trainer ALFRED, "HUBERT"
	tr_mon 22, NOCTOWL
	end_trainer
...
SailorGroup:
	...
	def_trainer HUEY1, "NEPOMUK"
	tr_mon 18, POLIWAG
	tr_mon 20, POLIWHIRL
	end_trainer

	def_trainer HUEY2, "NEPOMUK"
	tr_mon 28, POLIWHIRL
	tr_mon 28, POLIWHIRL
	end_trainer

	def_trainer HUEY3, "NEPOMUK"
	tr_mon 34, POLIWHIRL
	tr_mon 34, POLIWRATH
	end_trainer

	def_trainer HUEY4, "NEPOMUK"
	tr_mon 38, POLITOED
	...
	def_trainer EUGENE, "JUSTUS"
	tr_mon 17, POLIWHIRL
	tr_mon 17, RATICATE
	tr_mon 19, KRABBY
	end_trainer

	def_trainer TERRELL, "PEPE"
	tr_mon 20, POLIWHIRL
	end_trainer

	def_trainer KENT, "FERDINAND"
	tr_mon 18, KRABBY
	...
	def_trainer ERNEST, "KORNELIUS" ; MISMATCH
	tr_mon 18, MACHOP
	tr_mon 18, MACHOP
	tr_mon 18, POLIWHIRL
	end_trainer

	def_trainer JEFF, "OLE"
	tr_mon 46, RATICATE
	tr_mon 46, RATICATE
	end_trainer

	def_trainer GARRETT, "KASIMIR"
	tr_mon 48, KINGLER
	end_trainer

	def_trainer KENNETH, "OLAF"
	tr_mon 44, MACHOP
	tr_mon 45, MACHOKE
	tr_mon 46, POLIWRATH
	tr_mon 45, MACHOKE
	...
	def_trainer STANLY, "PASCAL" ; MISMATCH
	tr_mon 45, MACHOP
	tr_mon 48, MACHOKE
	tr_mon 44, PSYDUCK
	end_trainer

	def_trainer HARRY, "PIERRE"
	tr_mon 20, WOOPER
	end_trainer

	def_trainer PARKER, "BOGDAN"
	tr_mon 56, HORSEA
	tr_mon 57, SEADRA
	end_trainer

	def_trainer EDDIE, "FRANCO"
	tr_mon 59, AZUMARILL
	end_trainer

	def_trainer HARVEY, "HORST"
...
SwimmerMGroup:
	...
	def_trainer HAROLD, "ANATOL"
	tr_mon 60, REMORAID
	tr_mon 58, SEADRA
	end_trainer

	def_trainer SIMON, "GRIGORY"
	tr_mon 20, TENTACOOL
	tr_mon 20, TENTACOOL
	end_trainer

	def_trainer RANDALL, "MILOS"
	tr_mon 18, SHELLDER
	tr_mon 20, WARTORTLE
	tr_mon 18, SHELLDER
	end_trainer

	def_trainer CHARLIE, "PAVEL"
	tr_mon 21, SHELLDER
	tr_mon 19, TENTACOOL
	tr_mon 19, TENTACRUEL
	end_trainer

	def_trainer GEORGE, "PETRU"
	tr_mon 16, TENTACOOL
	tr_mon 17, TENTACOOL
	tr_mon 16, TENTACOOL
	tr_mon 19, STARYU
	...
	def_trainer BERKE, "YEVGENY"
	tr_mon 23, QWILFISH
	end_trainer

	def_trainer KIRK, "GENADI"
	tr_mon 20, GYARADOS
	tr_mon 20, GYARADOS
	end_trainer

	def_trainer MATHEW, "ALEXEI"
	tr_mon 23, KRABBY
	end_trainer

	def_trainer HAL, "PIOTR"
	tr_mon 24, SEEL
	tr_mon 25, DEWGONG
	tr_mon 24, SEEL
	end_trainer

	def_trainer JEROME, "IGOR"
	tr_mon 57, SEADRA
	tr_mon 58, TENTACOOL
...
SwimmerFGroup:
	...
	def_trainer ELAINE, "KÄTE"
	tr_mon 21, STARYU
	end_trainer

	def_trainer PAULA, "ELFI"
	tr_mon 19, STARYU
	tr_mon 19, SHELLDER
	end_trainer

	def_trainer KAYLEE, "KARIN"
	tr_mon 18, GOLDEEN
	tr_mon 20, GOLDEEN
	tr_mon 20, SEAKING
	end_trainer

	def_trainer SUSIE, "THEKLA"
	tr_mon 20, PSYDUCK
	tr_mon 22, GOLDEEN
	end_trainer

	def_trainer DENISE, "MAGDA"
	tr_mon 22, SEEL
	end_trainer

	def_trainer KARA, "HEIKE"
	tr_mon 20, STARYU
	tr_mon 20, STARMIE
	end_trainer

	def_trainer WENDY, "GERDA"
	tr_mon 21, HORSEA
	...
	def_trainer MARY, "ANITA"
	tr_mon 20, GYARADOS
	end_trainer

	def_trainer DAWN, "KLARA" ; MISMATCH
	tr_mon 61, AZUMARILL
	end_trainer

	def_trainer NICOLE, "ELKE"
	tr_mon 59, MARILL
	tr_mon 59, MARILL
	tr_mon 62, LAPRAS
	end_trainer

	def_trainer LORI, "DORIS"
	tr_mon 62, STARMIE
	tr_mon 62, STARMIE
	tr_mon 62, STARMIE
	end_trainer

	def_trainer NIKKI, "THEA"
	tr_mon 58, SEEL
	tr_mon 58, SEEL
	tr_mon 58, SEEL
	tr_mon 62, DEWGONG
	...
	def_trainer DIANA, "HEIDI"
	tr_mon 58, GOLDUCK
	end_trainer

	def_trainer BRIANA, "HELENE"
	tr_mon 56, SEAKING
	tr_mon 56, LAPRAS
	end_trainer
	...
	def_trainer KATIE, "ANKE" ; MISMATCH
	tr_mon LEVEL_FROM_BADGES + 3, LANTURN
	end_trainer

	def_trainer JILL, "AGNES"
	tr_mon LEVEL_FROM_BADGES + 3, DEWGONG
	end_trainer

	def_trainer LISA, "ILSE" ; MISMATCH
...
RocketScientistGroup:
	...
	def_trainer ROSS, "MARTIN"
	tr_mon 30, KOFFING, MALE
	tr_mon 30, GRIMER, MALE | ALOLAN_FORM
	end_trainer

	def_trainer MITCH, "HASSO"
	tr_mon 25, DITTO
	tr_mon 25, PORYGON
	end_trainer

	def_trainer JED, "THEODOR"
	tr_mon 29, MAGNEMITE
	tr_mon 30, MAGNETON
	tr_mon 29, MAGNEMITE
	end_trainer

	def_trainer MARC, "INGO" ; MISMATCH
	tr_mon 35, MAGNETON
	tr_mon 36, MAGNEMITE
	tr_mon 35, MAGNETON
	end_trainer

	def_trainer RICH, "RASSO" ; MISMATCH
	tr_mon 35, PORYGON_Z
...
BoarderGroup:
	...
	def_trainer RONALD, "LOUIS"
	tr_mon 33, SEEL
	tr_mon 35, DEWGONG
	tr_mon 33, SNEASEL
	end_trainer

	def_trainer BRAD, "KUNO"
	tr_mon 35, SWINUB
	tr_mon 35, SWINUB
	end_trainer

	def_trainer DOUGLAS, "GEORG"
	tr_mon 33, SHELLDER
	tr_mon 35, CLOYSTER
	tr_mon 33, SHELLDER
	end_trainer
...
SkierGroup:
	...
	def_trainer ROXANNE, "HELGA"
	tr_mon 36, JYNX
	end_trainer

	def_trainer CLARISSA, "SVENJA"
	tr_mon 36, PILOSWINE
	end_trainer
...
TeacherFGroup:
	...
	def_trainer COLETTE, "INCA"
	tr_mon 60, CLEFAIRY
	end_trainer

	def_trainer HILLARY, "SYLVIA"
	tr_mon 58, AIPOM
	tr_mon 56, SUNFLORA
	tr_mon 59, MAROWAK
	end_trainer

	def_trainer SHIRLEY, "HILTRUD"
...
GuitaristMGroup:
	...
	def_trainer CLYDE, "JIMMY"
	tr_mon 50, ELECTABUZZ
	end_trainer

	def_trainer VINCENT, "JOE"
	tr_mon 53, VOLTORB
	tr_mon 52, MAGNEMITE
	tr_mon 55, JOLTEON
	end_trainer
...
BikerGroup:
	...
	def_trainer HARRIS, "GASTON"
	tr_mon 57, FLAREON
	end_trainer

	def_trainer ZEKE, "EGIDIUS"
	tr_mon 55, KOFFING
	tr_mon 56, WEEZING
	end_trainer

	def_trainer CHARLES, "FRIDOLIN"
	tr_mon 54, KOFFING
	...
	def_trainer JOEL, "MANUEL"
	tr_mon 57, MAGMAR
	tr_mon 57, MAGMAR
	end_trainer

	def_trainer GLENN, "HEKTOR"
	tr_mon 55, KOFFING
	tr_mon 57, MAGMAR
	tr_mon 59, WEEZING
	end_trainer

	def_trainer DALE, "HUGO"
	tr_mon 57, MUK
	tr_mon 57, WEEZING
	end_trainer
...
CooltrainerMGroup:
	...
	def_trainer AARON, "ERNO"
	tr_mon 28, IVYSAUR
	tr_mon 28, CHARMELEON
	tr_mon 28, WARTORTLE
	end_trainer

	def_trainer CODY, "ARND"
	tr_mon 36, HORSEA
	tr_mon 37, SEADRA
	tr_mon 38, YANMA
	end_trainer

	def_trainer MIKE, "RALF"
	tr_mon 38, DRAGONAIR
	end_trainer

	def_trainer RYAN, "ARNE"
	tr_mon 35, PIDGEOT
	...
	def_trainer ANDY, "HIOB"
	tr_mon 10, BULBASAUR
	tr_mon 10, CHARMANDER
	tr_mon 10, SQUIRTLE
	end_trainer

	def_trainer SEAN, "AMON"
	tr_mon 47, FLAREON
	tr_mon 47, TANGELA
	tr_mon 47, TAUROS
	end_trainer

	def_trainer KEVIN, "NICO"
	tr_mon 54, RHYDON
	tr_mon 56, CHARIZARD
	tr_mon 56, BLASTOISE
	end_trainer

	def_trainer ALLEN, "STAN"
	...
	def_trainer COOLTRAINERM_COREY, "EDUARD"
	...
	def_trainer COOLTRAINERM_RAYMOND, "ALBERT" ; MISMATCH
...
endc
	...
	def_trainer REENA1, "BEA"
	tr_mon 37, ARCANINE
	tr_mon 40, NIDOQUEEN
	tr_mon 38, STARMIE
	end_trainer

	def_trainer REENA2, "BEA"
	tr_mon 41, ARCANINE
	tr_mon 44, NIDOQUEEN
	tr_mon 42, STARMIE
	end_trainer

	def_trainer REENA3, "BEA"
	tr_mon 45, ARCANINE
	...
	def_trainer LOIS, "KARO"
	tr_mon 29, JUMPLUFF
	tr_mon 29, NINETALES
	end_trainer

	def_trainer FRAN, "ALMA"
if DEF(FAITHFUL)
	tr_mon 39, SEADRA
else
	tr_mon 39, CHARIZARD
endc
	...
	def_trainer LOLA, "ROSI"
	tr_mon 36, DRATINI
	tr_mon 38, DRAGONAIR
	end_trainer

	def_trainer KATE, "EDNA"
	tr_mon 26, SHELLDER
	tr_mon 28, CLOYSTER
	end_trainer

	def_trainer IRENE, "LOLA"
	tr_mon 22, GOLDEEN
	tr_mon 24, SEAKING
	end_trainer

	def_trainer KELLY, "MIRA"
	tr_mon 37, MARILL
	tr_mon 35, WARTORTLE
	tr_mon 35, CROCONAW
	end_trainer

	def_trainer JOYCE, "SUSI"
	tr_mon 37, PIKACHU
	...
	def_trainer CAROL, "BINE"
	tr_mon 47, ELECTRODE
	tr_mon 47, STARMIE
	tr_mon 47, NINETALES
	end_trainer

	def_trainer QUINN, "ILKA"
	tr_mon 63, VENUSAUR
	tr_mon 62, STARMIE
	end_trainer

	def_trainer EMMA, "ULLA"
	tr_mon 28, POLIWHIRL
	end_trainer

	def_trainer CYBIL, "KORA"
