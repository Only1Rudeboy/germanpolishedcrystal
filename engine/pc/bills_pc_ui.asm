...
.CantReleaseEgg:
	text "Ein Ei kannst du"
	line "nicht freilassen!"
	prompt

.CantReleaseHMMons:
	text "<PK><MN> mit VM-"
	line "Attacken kannst du"
	cont "nicht freilassen!"
	prompt
