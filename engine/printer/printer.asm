...
GBPrinterString_CheckingLink: next " Prüfe Verbindung…@"
GBPrinterString_Transmitting: next "  Übertrage…@"
GBPrinterString_Printing:     next "    Drucke…@"
GBPrinterString_PrinterError1:
	db   " Druckerfehler 1"
	next ""
	next "Die Batterien sind"
	next "leer."
	db   "@"
