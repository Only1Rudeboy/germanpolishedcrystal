...
Phone_GrandmaString: db "Oma@"
Phone_GrandpaString: db "Opa@"
Phone_MomString:     db "Mama@"
Phone_DadString:     db "Papa@"
Phone_SisterString:  db "Schwester@"
Phone_BrotherString: db "Bruder@"
